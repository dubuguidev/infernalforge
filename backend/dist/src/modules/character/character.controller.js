...
let CharacterController = class CharacterController {
    ...
    create(createCharacterDto, file) {
    ...
    update(id, updateCharacterDto, file) {
...
__decorate([
    (0, common_1.Post)(),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('image', multer_config_1.characterMulterOptions)),
